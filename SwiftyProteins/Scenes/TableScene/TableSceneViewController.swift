...
extension TableSceneViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let reusableCell = tableView.dequeueReusableCell(withIdentifier: "ProteinCell", for: indexPath)
        let proteinCell = reusableCell as? ProteinCell
        proteinCell?.proteinNameLabel.text = model.proteinsList[indexPath.row]
        proteinCell?.activityIndicator.isHidden = true
